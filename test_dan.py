...
def main():
    test_location = '/home/uni/Desktop/DAN/dan_updated2209_Folder/test_images/'
    ...
    for th in threshold_values:
        ...
        for fold in os.listdir(test_location):
            sub_folders = os.listdir(test_location + fold)
            sub_folder_1 = test_location + fold + '/' + sub_folders[0]
            sub_folder_2 = test_location + fold + '/' + sub_folders[1]
